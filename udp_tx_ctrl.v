 ...
 ** File	:	E:/lab202509/al56pingjie/al_ip/udp_tx_ctrl.v
 ** Date	:	2025 10 08
 ** TD version	:	5.6.119222
\************************************************************/
module udp_tx_ctrl #(parameter DATA_WIDTH_W = 8, 
        parameter DATA_WIDTH_R = 8, 
        parameter ADDR_WIDTH_W = 13, 
        parameter ADDR_WIDTH_R = 13, 
        parameter AL_FULL_NUM = 8189, 
    ...
    // =============================================
    ram_infer_udp_tx_ctrl #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module ram_infer_udp_tx_ctrl (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
