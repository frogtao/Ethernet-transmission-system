 ...
 ** File	:	E:/lab202509/al56_detect/al_ip/delay_fifo.v
 ** Date	:	2025 10 08
 ** TD version	:	5.6.119222
\************************************************************/
module delay_fifo #(parameter DATA_WIDTH_W = 16, 
    ...
    fifo_cross_domain_addr_process_al_delay_fifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_delay_fifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_delay_fifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module fifo_cross_domain_addr_process_al_delay_fifo #(parameter ADDR_WIDTH = 9) (
...
`timescale 1ns/1ps
module ram_infer_delay_fifo (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
