 ...
 ** File	:	E:/lab202509/al56_detect/al_ip/fifo_sdr_data_2.v
 ** Date	:	2025 10 12
 ** TD version	:	5.6.119222
\************************************************************/
module fifo_sdr_data_2 #(parameter DATA_WIDTH_W = 8, 
        parameter DATA_WIDTH_R = 8, 
        parameter ADDR_WIDTH_W = 11, 
        parameter ADDR_WIDTH_R = 11, 
        parameter AL_FULL_NUM = 2045, 
    ...
    fifo_cross_domain_addr_process_al_fifo_sdr_data_2 #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_fifo_sdr_data_2 #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_fifo_sdr_data_2 #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module fifo_cross_domain_addr_process_al_fifo_sdr_data_2 #(parameter ADDR_WIDTH = 9) (
...
`timescale 1ns/1ps
module ram_infer_fifo_sdr_data_2 (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
